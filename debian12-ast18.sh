...
# Install Dahdi
echo "Install Dahdi"
sudo apt-get install -y dahdi dahdi-linux dahdi-tools libdahdi-dev asterisk-dahdi dahdi-firmware-nonfree
...
rm -f asterisk-18.21.0-vici.tar.gz
rm -f libpri-1.6.1.tar.gz
